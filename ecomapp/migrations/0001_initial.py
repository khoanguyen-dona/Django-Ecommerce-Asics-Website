# Generated by Django 4.2.6 on 2023-12-06 04:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Order received', 'Order received'), ('Order processing', 'Order processing'), ('On delivery', 'On delivery'), ('Order completed', 'Order completed'), ('Order canceled', 'Order canceled')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='customer_avatar')),
